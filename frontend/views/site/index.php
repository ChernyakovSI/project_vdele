                        ...
                        <div class="grid-slider">
                            ...
                            <div class="text-font item-text">
                                ...
                                <div>- познание себя (постоянный процесс)
                                    <br>
                                    - осознанная жизнь, воля, совесть, нравственность
                                    <br>
                                    - вера и источники силы
                                    <br>
                                    - прохождение своего жизненного пути
                                    <br>
                                    - внутреннее состояние, счастье и любовь
                                    <br>
                                    - непривязанность, благодарность, щедрость
                                    <br>
                                    - автобиография
                                    <br>
                    ...
                    <div class="slides slide8 window-border col-back-tra">
                        <div class="grid-slider">
                            ...
                            <div class="text-font item-text">
                                ...
                                <br>
                                - ощущение полноты жизни, силы, чувство свободы
                                <div></div>
                            </div>
                        </div>
                    </div>
